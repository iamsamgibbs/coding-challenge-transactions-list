            ...
            <div className="bg-white border shadow-sm rounded-xl w-modal">
              ...
              <div className="p-4 overflow-y-auto">
                ...
                <input
                  ...
                  {...register('sender', { disabled: true })}
                />
                {errors.sender?.type === 'required' && <p role="alert">Sender is required</p>}
                ...
                <input
                  ...
                  {...register('recipient', { required: true, minLength: 42, maxLength: 42 })}
                  aria-invalid={errors.recipient ? 'true' : 'false'}
                />
                {errors.recipient?.type === 'required' && <p role="alert">Recipient is required</p>}
